package com.example.usuario.inventorydatabase;
...
public class LoginInstrumentedTest {
    ...
    public void isUserEmpty() throws Exception {
        onView(withId(com.example.usuario.inventorydatabase.R.id.edtUser)).perform(click());
        checkSnackBarDisplayByMessage(com.example.usuario.inventorydatabase.R.string.errorUserEmpty);
    }
    /**
    ...
    public void isEmailEmpty() throws Exception {
        onView(withId(com.example.usuario.inventorydatabase.R.id.edtUser)).perform(click());
        checkSnackBarDisplayByMessage(com.example.usuario.inventorydatabase.R.string.errorEmailEmpty);
    }
    /**
    ...
    public void isPasswordEmpty() throws Exception {
        onView(withId(com.example.usuario.inventorydatabase.R.id.edtUser)).perform(click());
        checkSnackBarDisplayByMessage(com.example.usuario.inventorydatabase.R.string.errorPasswordEmpty);
    }
    /**
    ...
    public void passwordLength() throws Exception {
        onView(withId(com.example.usuario.inventorydatabase.R.id.edtUser)).perform(typeText("lourdes"), closeSoftKeyboard());
        onView(withId(com.example.usuario.inventorydatabase.R.id.edtPassword)).perform(typeText("lu"), closeSoftKeyboard());
        onView(withId(com.example.usuario.inventorydatabase.R.id.btnSignIn)).perform(click());
        checkSnackBarDisplayByMessage(com.example.usuario.inventorydatabase.R.string.errorPassword);
    }
